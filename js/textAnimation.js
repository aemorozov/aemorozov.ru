...
let timeToThirdString = h1_2Arr.length * time * interval       // задаём время до появления второй строки используя длину первой строки

firstLine()                                         // запускаем первую функцию (строку) сразу
setTimeout(secondLine, timeToSecondString)
// setTimeout(thirdLine, timeToThirdString)          // запускаем вторую строку через время, когда кончится первая
